...
Port (
	...
	i_InstrStall	: in std_ulogic; -- action � introduire en laboratoire
...
begin
	...
	-- i_InstrStall -doit- intervenir � des endroits strat�giques ci-bas
	-- lesquels? Il y en a plus qu'un.
	o_RegWrite		<=  not i_InstrStall and '1' when i_Op = OP_Rtype or 
								                      i_Op = OP_ADDI or 
								                      i_Op = OP_ADDIU or 
								                      i_Op = OP_ORI or 
								                      i_Op = OP_LUI or 
	...
	o_MemWrite 		<= not i_InstrStall AND '1' when i_Op = OP_SW else '0';

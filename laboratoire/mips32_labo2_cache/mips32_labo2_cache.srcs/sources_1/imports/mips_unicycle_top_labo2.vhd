...
Port ( 
	...
	signal s_alu_mult       : std_ulogic;
	signal s_mflo           : std_ulogic;
	signal s_mfhi           : std_ulogic;

	signal s_InstrStall	: std_ulogic;

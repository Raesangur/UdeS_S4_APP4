...
end mips_pipeline_top;

architecture Behavioral of mips_pipeline_top is
...
component mips_datapath_pipeline is
Port ( 
	clk 			: in std_ulogic;
	reset 			: in std_ulogic;
...
-- Chemin de données
inst_Datapath :  mips_datapath_pipeline
Port map( 
	clk 			=> clk,
	reset 			=> reset,
